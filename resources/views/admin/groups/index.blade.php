            ...
            <div class="bg-transparent overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between mb-6">
                        <h3 class="text-lg font-medium">Liste des Groupes</h3>
                        <a href="{{ route('admin.groups.create') }}" class="bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded">
                            Ajouter un Groupe
                        </a>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-transparent">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Étudiants</th>
                        ...
                        <tbody class="bg-transparent divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach ($groups as $group)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $group->students_count }}</td>
                                     <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.groups.edit', $group) }}" class="text-indigo-600 hover:text-indigo-900 mr-4">Modifier</a>
